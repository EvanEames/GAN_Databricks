...
# MAGIC %run "/Users/evan@datainsights.de/GAN_Invisibility_Cloak/options/base_options"
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_server', type=str, default="http://ec2-18-217-157-134.us-east-2.compute.amazonaws.com", help='visdom server of the web display')
        ...
        parser.add_argument('--lr', type=float, default=0.0002, help='initial learning rate for adam') #true_default = 0.0002
