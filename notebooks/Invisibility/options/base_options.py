...
# MAGIC %run "/Users/evan@datainsights.de/GAN_Invisibility_Cloak/util/util"
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', type=str, default = '/dbfs/evan/invisibility', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='Invisibility', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='/dbfs/evan/pix2pix/checkpoints', help='models are saved here')
        # model parameters
    ...
    def gather_options(self):
        ...
        """
        parser = argparse.ArgumentParser(prog='Suppy_Args_in_Options_Files', add_help=False)
        ...
        self.parser = parser
        return parser.parse_args(['--dataroot=/dbfs/evan/invisibility'])
